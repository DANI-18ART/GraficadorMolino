...
function rotateObjectY(obj, af, totalIterations) {
    ...
    function rotateStep() {
        ...
        if (currentIteration <= totalIterations) {
            setTimeout(rotateStep, 300); // Llamar a la función nuevamente después de 100ms
        }
    }
    rotateStep();
}
function calculateCenter(obj) {
    ...
    var numVertices = 858; // Número total de vértices del objeto
...
document.getElementById('pza1Der').addEventListener('click', function () { rotateObjectY(obj, -20, 250); }, false);
